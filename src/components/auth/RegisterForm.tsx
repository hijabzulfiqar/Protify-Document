          ...
          <div className="text-center space-y-4">
            ...
            >
              ...
              <p className="text-gray-600">
                Join thousands of students on Portify
              </p>
            </motion.div>
          </div>
              ...
              <FormField name="fullName">
                ...
                <div className="relative mt-2">
                  <Input
                    ...
                    className="block w-full px-4 py-3 pl-11 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all duration-200"
                    {...register("fullName")}
                  />
              ...
              <FormField name="password">
                ...
                <div className="relative mt-2">
                  <Input
                    ...
                    className="block w-full px-4 py-3 pl-11 pr-12 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all duration-200"
                    {...register("password")}
                  />
